...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 995,
    unit: "kg",
    description: "100% organic single-origin Tanzania cacao paste — the premium choice for drinking cacao and artisan chocolate.",
    longDesc: "Stone-ground from whole organic cacao beans. Available in 250g, 500g, 1kg and 5kg sizes. Wholesale pricing available for cafés and trade from R750/kg. The gold standard for rich, ceremonial-grade drinking cacao.",
